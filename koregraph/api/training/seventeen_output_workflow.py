...
from koregraph.api.machine_learning.neural_network import initialize_model_seventeen_output
...
from koregraph.api.preprocessing.posture_preprocessing import get_articulation
...
def train_workflow(
    ...
    Xs = [get_articulation(X, i) for i in range(17)]
    model = initialize_model_seventeen_output(Xs, y) if backup_model is None else backup_model
