...
from koregraph.api.preprocessing.posture_preprocessing import cut_percentage, get_articulation
...
def predict_seventeen(
    ...
    # Predict first frame
    print("Prediction 0")
    prediction = model.predict([get_articulation(input, i) for i in range(17)])
