...
from koregraph.params import AUDIO_DIRECTORY, GENERATED_PICKLE_DIRECTORY, ALL_ADVANCED_MOVE_NAMES
...
def generate_pickle_files():
    for move_name in ALL_ADVANCED_MOVE_NAMES:
        try:
            ...
            with open(GENERATED_PICKLE_DIRECTORY/('generated_' + move_name), 'wb') as f:
